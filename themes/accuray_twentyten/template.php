 ...
 *   entirety and paste it here, changing the prefix from theme_ to accuray_twentyten_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: accuray_breadcrumb()
 *
 *   where accuray is the name of your sub-theme. For example, the
 ...
 */
function accuray_theme(&$existing, $type, $theme, $path) {
...
function accuray_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function accuray_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // accuray_preprocess_node_page() or accuray_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function accuray_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function accuray_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
